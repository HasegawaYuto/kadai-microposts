                                    ...
                                    CanResetPasswordContract
{
    ...
    {
        return $this->belongsToMany(Micropost::class, 'favorite_post', 'user_id', 'micropost_id')->withTimestamps();
    }
    ...
    {
        $favorite_micropost_ids = $this->favoring()->lists('microposts.id')->toArray();
